...
DEFAULT_STAR_PACKS: tuple[StarPack, ...] = (
    StarPack(
        pack_id="small",
        title="Pack S — 100 запросов",
        description="+100 текстовых запросов, +5 картинок",
        stars=100,
        text_credits=100,
        image_credits=5,
    ),
    StarPack(
        pack_id="medium",
        title="Pack M — 500 запросов",
        description="+500 текстовых запросов, +30 картинок",
        stars=300,
        text_credits=500,
        image_credits=30,
    ),
    StarPack(
        pack_id="large",
        title="Pack L — Безлимит на 30 дней",
        description="Безлимитный текст и картинки на 30 дней",
        stars=1000,
        unlimited_days=30,
    ),
)
